...
export const BLUE_NUMBERS = [One_B,Two_B,Three_B,Four_B,Five_B,Six_B,Seven_B,Eight_B,Nine_B,Ten_B]
export const RED_NUMBERS = [One_R,Two_R,Three_R,Four_R,Five_R,Six_R,Seven_R,Eight_R,Nine_R,Ten_R]
export const ORANGE_NUMBERS = [One_O,Two_O,Three_O,Four_O,Five_O,Six_O,Seven_O,Eight_O,Nine_O,Ten_O]
export const PINK_NUMBERS = [One_Pi,Two_Pi,Three_Pi,Four_Pi,Five_Pi,Six_Pi,Seven_Pi,Eight_Pi,Nine_Pi,Ten_Pi]
export const PURPLE_NUMBERS = [One_P,Two_P,Three_P,Four_P,Five_P,Six_P,Seven_P,Eight_P,Nine_P,Ten_P]
export const GREEN_NUMBERS = [One_G,Two_G,Three_G,Four_G,Five_G,Six_G,Seven_G,Eight_G,Nine_G,Ten_G]


export const FOUR_NUMBER_SHAPES = [Four_B,
 Four_P,
 Four_Pi,Four_R,
 Four_O,Four_G]
...
const NUMERALS = [new NUMBER_ONE(),new NUMBER_TWO(),new NUMBER_THREE(),new NUMBER_FOUR(),
  new NUMBER_FIVE(),new NUMBER_SIX(),new NUMBER_SEVEN(),new NUMBER_EIGHT(),new NUMBER_NINE(),new NUMBER_TEN()]
...
export const shuffleNumbersWithType = (type) => {
  console.log("LOOKING FOR NUMBERS WITH TYPE")
  switch (type) {
    case (Types.BLUE): {
      console.log("LOOKING FOR BLUE TYPES!!!!")
...
const SIZES_ARRAY = [sizes_zero,sizes_one,sizes_two,sizes_three,sizes_four,
  sizes_five,sizes_six,sizes_seven,sizes_eight,
sizes_nine,sizes_ten]

const CONFIG_ARRAY = [config_zero,config_one,config_two,config_three,config_four,
  config_five,config_six,config_seven,config_eight,
config_nine,config_ten]

const NUM_ARRAY = [num_zero,num_one,num_two,num_three,num_four,
  num_five,num_six,num_seven,num_eight,
num_nine,num_ten]

const EO_ARRAY = [eo_zero,eo_one,eo_two,eo_three,eo_four,
  eo_five,eo_six,eo_seven,eo_eight,
eo_nine,eo_ten]

const FRAME_ARRAY = [frame_zero,frame_one,frame_two,frame_three,frame_four,
frame_five,frame_six,frame_seven,frame_eight,
frame_nine,frame_ten]

const CIRC_ARRAY = [circ_zero,circ_one,circ_two,circ_three,circ_four,
  circ_five,circ_six,circ_seven,circ_eight,
circ_nine,circ_ten]
...
export const initAllNumberShapes = () => {
  ...
  let nines = initNines()
  let tens = initTens()
  return [...fours,...fives,...sixes,...sevens,...eights,...nines,...tens]
}
...
export const getLevel = (level) => {
  ...
  let objects =  allShapes.filter(e => (e.value < upperBound && e.value > lowerBound))
...
/*export const VISUAL_ARRAYS_PROPS = [...CIRC_ARRAY_PROPS,...CONFIG_ARRAY_PROPS,
  ...SIZES_ARRAY_PROPS,...EO_ARRAY_PROPS,...FRAME_ARRAY_PROPS]
  */
...
export const getObjectsForCardType = (objects,type) =>  {
  ...
  export const VISUAL_ARRAYS_PROPS = [...CONFIG_ARRAY_PROPS,
    ...SIZES_ARRAY_PROPS,...EO_ARRAY_PROPS,...FRAME_ARRAY_PROPS]
